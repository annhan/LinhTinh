...
{
	if (!inUsedByAnalog) {
		static boolean wasLightedUp = false; //biến tĩnh là gì http://arduino.vn/reference/static-bien-tinh
...
//lấy ram còn trong arduino :3 http://arduino.vn/bai-viet/356-tiet-kiem-ram-trong-arduino
int getMemoryFree() {
